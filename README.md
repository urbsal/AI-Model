...
#### Create a virtual environment with python 3.14.0 version,
...
### Documents 
#### Sample documents are available in documents folder and an user can add more file such as pdf, dox or txt file into the folder. 

#### The user can insert the required quotes into the UI and set the number of desire output by changing the settings. 
